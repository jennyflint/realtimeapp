                ...
                <div class="p-0 sm:p-6">
                    ...
                    <div class="divide-y divide-gray-200">
                        @foreach ($users as $user)
                            <div
                                class="grid grid-cols-1 md:grid-cols-12 p-4 md:px-6 md:py-4 items-center hover:bg-gray-50 transition duration-150">

                                <div class="col-span-1 md:col-span-4 flex items-center mb-2 md:mb-0">
                                    <div
                                        class="h-10 w-10 shrink-0 rounded-full bg-indigo-500 flex items-center justify-center text-white font-bold">
                                        {{ strtoupper(substr($user->name, 0, 1)) }}
                                    </div>
                                    <div class="ml-4">
                                        <div class="text-sm font-semibold md:font-medium text-gray-900">{{ $user->name }}
                                        </div>
                                ...
                                <div class="col-span-1 md:col-span-3 text-left md:text-right mt-2 md:mt-0">
                                    <button @click="openModal({{ $user->id }}, @js($user->name))"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1.5 md:hidden" fill="none"
